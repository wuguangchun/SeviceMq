...
{
	/// <summary>
	/// Strongly-typed collection for the TPlanMDelete class.
	/// </summary>
    [Serializable]
	public partial class TPlanMDeleteCollection : ActiveList<TPlanMDelete, TPlanMDeleteCollection>
	{	   
		public TPlanMDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TPlanMDeleteCollection</returns>
		public TPlanMDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TPlanMDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_PlanM_delete table.
	/// </summary>
	[Serializable]
	public partial class TPlanMDelete : ActiveRecord<TPlanMDelete>, IActiveRecord
	{
		...
		public TPlanMDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TPlanMDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TPlanMDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_PlanM_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_PlanM_delete",schema);
			}
		}
		#endregion
