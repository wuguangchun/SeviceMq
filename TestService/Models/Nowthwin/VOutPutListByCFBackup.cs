...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the VOutPutListByCFBackup class.
    /// </summary>
    [Serializable]
    public partial class VOutPutListByCFBackupCollection : ReadOnlyList<VOutPutListByCFBackup, VOutPutListByCFBackupCollection>
    {        
        public VOutPutListByCFBackupCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_outPutListByCF_Backup view.
    /// </summary>
    [Serializable]
    public partial class VOutPutListByCFBackup : ReadOnlyRecord<VOutPutListByCFBackup>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_outPutListByCF_Backup", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_outPutListByCF_Backup",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOutPutListByCFBackup()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOutPutListByCFBackup(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOutPutListByCFBackup(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOutPutListByCFBackup(string columnName, object columnValue)
        {
            SetSQLProps();
