...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisErpList class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisErpListCollection : ActiveList<TAnalysisErpList, TAnalysisErpListCollection>
	{	   
		public TAnalysisErpListCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisErpListCollection</returns>
		public TAnalysisErpListCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisErpList o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_ErpList table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisErpList : ActiveRecord<TAnalysisErpList>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisErpList()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisErpList(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisErpList(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisErpList(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_ErpList", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_ErpList",schema);
			}
		}
		#endregion
