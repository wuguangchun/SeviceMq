...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the ViewApsOrder class.
    /// </summary>
    [Serializable]
    public partial class ViewApsOrderCollection : ReadOnlyList<ViewApsOrder, ViewApsOrderCollection>
    {        
        public ViewApsOrderCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_aps_orders view.
    /// </summary>
    [Serializable]
    public partial class ViewApsOrder : ReadOnlyRecord<ViewApsOrder>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_aps_orders", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                colvarScyxjb.DataType = DbType.String;
                colvarScyxjb.MaxLength = 384;
                ...
                colvarScptsl.DataType = DbType.String;
                colvarScptsl.MaxLength = 384;
                ...
                DataService.Providers["Nowthwin"].AddSchema("View_aps_orders",schema);
            }
        }
        #endregion
        ...
        public ViewApsOrder(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewApsOrder(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewApsOrder(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        [XmlAttribute("Scyxjb")]
        [Bindable(true)]
        public string Scyxjb 
	    {
		    get
		    {
			    return GetColumnValue<string>("SCYXJB");
		    }
            set 
		    {
        ...
        [XmlAttribute("Scptsl")]
        [Bindable(true)]
        public string Scptsl 
	    {
		    get
		    {
			    return GetColumnValue<string>("SCPTSL");
		    }
            set 
		    {
