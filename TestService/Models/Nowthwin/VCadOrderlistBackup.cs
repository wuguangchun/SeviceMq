...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the VCadOrderlistBackup class.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistBackupCollection : ReadOnlyList<VCadOrderlistBackup, VCadOrderlistBackupCollection>
    {        
        public VCadOrderlistBackupCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_CAD_ORDERLIST_backup view.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistBackup : ReadOnlyRecord<VCadOrderlistBackup>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_CAD_ORDERLIST_backup", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_CAD_ORDERLIST_backup",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VCadOrderlistBackup()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VCadOrderlistBackup(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VCadOrderlistBackup(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VCadOrderlistBackup(string columnName, object columnValue)
        {
            SetSQLProps();
