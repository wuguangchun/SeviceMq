...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the VOrderListCadXf class.
    /// </summary>
    [Serializable]
    public partial class VOrderListCadXfCollection : ReadOnlyList<VOrderListCadXf, VOrderListCadXfCollection>
    {        
        public VOrderListCadXfCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_OrderList_CAD_XF view.
    /// </summary>
    [Serializable]
    public partial class VOrderListCadXf : ReadOnlyRecord<VOrderListCadXf>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_OrderList_CAD_XF", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_OrderList_CAD_XF",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOrderListCadXf()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOrderListCadXf(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOrderListCadXf(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOrderListCadXf(string columnName, object columnValue)
        {
            SetSQLProps();
