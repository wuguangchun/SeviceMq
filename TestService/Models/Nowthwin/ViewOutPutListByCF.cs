...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the ViewOutPutListByCF class.
    /// </summary>
    [Serializable]
    public partial class ViewOutPutListByCFCollection : ReadOnlyList<ViewOutPutListByCF, ViewOutPutListByCFCollection>
    {        
        public ViewOutPutListByCFCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_outPutListByCF view.
    /// </summary>
    [Serializable]
    public partial class ViewOutPutListByCF : ReadOnlyRecord<ViewOutPutListByCF>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_outPutListByCF", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("View_outPutListByCF",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewOutPutListByCF()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewOutPutListByCF(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewOutPutListByCF(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewOutPutListByCF(string columnName, object columnValue)
        {
            SetSQLProps();
