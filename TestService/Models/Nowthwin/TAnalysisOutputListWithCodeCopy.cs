...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOutputListWithCodeCopy class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOutputListWithCodeCopyCollection : ActiveList<TAnalysisOutputListWithCodeCopy, TAnalysisOutputListWithCodeCopyCollection>
	{	   
		public TAnalysisOutputListWithCodeCopyCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOutputListWithCodeCopyCollection</returns>
		public TAnalysisOutputListWithCodeCopyCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOutputListWithCodeCopy o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OutputListWithCode_copy table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOutputListWithCodeCopy : ActiveRecord<TAnalysisOutputListWithCodeCopy>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOutputListWithCodeCopy()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOutputListWithCodeCopy(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOutputListWithCodeCopy(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOutputListWithCodeCopy(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OutputListWithCode_copy", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OutputListWithCode_copy",schema);
			}
		}
		#endregion
