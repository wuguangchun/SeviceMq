...
namespace Model
{
	...
	public partial class SCT282 : ActiveRecord<SCT282>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT282", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("SCT282",schema);
			}
		}
		#endregion
