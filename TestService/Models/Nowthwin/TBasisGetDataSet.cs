...
{
	/// <summary>
	/// Strongly-typed collection for the TBasisGetDataSet class.
	/// </summary>
    [Serializable]
	public partial class TBasisGetDataSetCollection : ActiveList<TBasisGetDataSet, TBasisGetDataSetCollection>
	{	   
		public TBasisGetDataSetCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBasisGetDataSetCollection</returns>
		public TBasisGetDataSetCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBasisGetDataSet o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Basis_GetDataSet table.
	/// </summary>
	[Serializable]
	public partial class TBasisGetDataSet : ActiveRecord<TBasisGetDataSet>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBasisGetDataSet()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBasisGetDataSet(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBasisGetDataSet(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBasisGetDataSet(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Basis_GetDataSet", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Basis_GetDataSet",schema);
			}
		}
		#endregion
