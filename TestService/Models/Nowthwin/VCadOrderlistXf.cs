...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the VCadOrderlistXf class.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistXfCollection : ReadOnlyList<VCadOrderlistXf, VCadOrderlistXfCollection>
    {        
        public VCadOrderlistXfCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_CAD_ORDERLIST_XF view.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistXf : ReadOnlyRecord<VCadOrderlistXf>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_CAD_ORDERLIST_XF", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_CAD_ORDERLIST_XF",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VCadOrderlistXf()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VCadOrderlistXf(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VCadOrderlistXf(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VCadOrderlistXf(string columnName, object columnValue)
        {
            SetSQLProps();
