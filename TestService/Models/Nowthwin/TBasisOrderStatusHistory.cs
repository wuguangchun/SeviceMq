...
{
	/// <summary>
	/// Strongly-typed collection for the TBasisOrderStatusHistory class.
	/// </summary>
    [Serializable]
	public partial class TBasisOrderStatusHistoryCollection : ActiveList<TBasisOrderStatusHistory, TBasisOrderStatusHistoryCollection>
	{	   
		public TBasisOrderStatusHistoryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBasisOrderStatusHistoryCollection</returns>
		public TBasisOrderStatusHistoryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBasisOrderStatusHistory o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Basis_OrderStatus@History table.
	/// </summary>
	[Serializable]
	public partial class TBasisOrderStatusHistory : ActiveRecord<TBasisOrderStatusHistory>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBasisOrderStatusHistory()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBasisOrderStatusHistory(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBasisOrderStatusHistory(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBasisOrderStatusHistory(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Basis_OrderStatus@History", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Basis_OrderStatus@History",schema);
			}
		}
		#endregion
