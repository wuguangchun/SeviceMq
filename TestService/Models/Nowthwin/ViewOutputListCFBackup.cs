...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the ViewOutputListCFBackup class.
    /// </summary>
    [Serializable]
    public partial class ViewOutputListCFBackupCollection : ReadOnlyList<ViewOutputListCFBackup, ViewOutputListCFBackupCollection>
    {        
        public ViewOutputListCFBackupCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_outputListCF_Backup view.
    /// </summary>
    [Serializable]
    public partial class ViewOutputListCFBackup : ReadOnlyRecord<ViewOutputListCFBackup>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_outputListCF_Backup", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("View_outputListCF_Backup",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewOutputListCFBackup()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewOutputListCFBackup(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewOutputListCFBackup(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewOutputListCFBackup(string columnName, object columnValue)
        {
            SetSQLProps();
