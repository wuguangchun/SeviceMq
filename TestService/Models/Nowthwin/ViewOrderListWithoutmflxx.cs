...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the ViewOrderListWithoutmflxx class.
    /// </summary>
    [Serializable]
    public partial class ViewOrderListWithoutmflxxCollection : ReadOnlyList<ViewOrderListWithoutmflxx, ViewOrderListWithoutmflxxCollection>
    {        
        public ViewOrderListWithoutmflxxCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_orderListWithoutmflxx view.
    /// </summary>
    [Serializable]
    public partial class ViewOrderListWithoutmflxx : ReadOnlyRecord<ViewOrderListWithoutmflxx>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_orderListWithoutmflxx", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("View_orderListWithoutmflxx",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewOrderListWithoutmflxx()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewOrderListWithoutmflxx(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewOrderListWithoutmflxx(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewOrderListWithoutmflxx(string columnName, object columnValue)
        {
            SetSQLProps();
