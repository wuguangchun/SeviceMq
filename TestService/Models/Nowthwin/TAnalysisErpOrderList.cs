...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisErpOrderList class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisErpOrderListCollection : ActiveList<TAnalysisErpOrderList, TAnalysisErpOrderListCollection>
	{	   
		public TAnalysisErpOrderListCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisErpOrderListCollection</returns>
		public TAnalysisErpOrderListCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisErpOrderList o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_ErpOrderList table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisErpOrderList : ActiveRecord<TAnalysisErpOrderList>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisErpOrderList()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisErpOrderList(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisErpOrderList(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisErpOrderList(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_ErpOrderList", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_ErpOrderList",schema);
			}
		}
		#endregion
