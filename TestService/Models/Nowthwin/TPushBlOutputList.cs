...
{
	/// <summary>
	/// Strongly-typed collection for the TPushBlOutputList class.
	/// </summary>
    [Serializable]
	public partial class TPushBlOutputListCollection : ActiveList<TPushBlOutputList, TPushBlOutputListCollection>
	{	   
		public TPushBlOutputListCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TPushBlOutputListCollection</returns>
		public TPushBlOutputListCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TPushBlOutputList o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_PushBlOutputList table.
	/// </summary>
	[Serializable]
	public partial class TPushBlOutputList : ActiveRecord<TPushBlOutputList>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TPushBlOutputList()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TPushBlOutputList(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TPushBlOutputList(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TPushBlOutputList(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_PushBlOutputList", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_PushBlOutputList",schema);
			}
		}
		#endregion
