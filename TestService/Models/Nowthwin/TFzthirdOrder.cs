...
{
	/// <summary>
	/// Strongly-typed collection for the TFzthirdOrder class.
	/// </summary>
    [Serializable]
	public partial class TFzthirdOrderCollection : ActiveList<TFzthirdOrder, TFzthirdOrderCollection>
	{	   
		public TFzthirdOrderCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TFzthirdOrderCollection</returns>
		public TFzthirdOrderCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TFzthirdOrder o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_fzthirdOrder table.
	/// </summary>
	[Serializable]
	public partial class TFzthirdOrder : ActiveRecord<TFzthirdOrder>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TFzthirdOrder()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TFzthirdOrder(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TFzthirdOrder(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TFzthirdOrder(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_fzthirdOrder", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_fzthirdOrder",schema);
			}
		}
		#endregion
