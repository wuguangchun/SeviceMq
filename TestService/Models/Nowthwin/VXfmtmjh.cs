...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VXfmtmjh class.
    /// </summary>
    [Serializable]
    public partial class VXfmtmjhCollection : ReadOnlyList<VXfmtmjh, VXfmtmjhCollection>
    {        
        public VXfmtmjhCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the v_xfmtmjh view.
    /// </summary>
    [Serializable]
    public partial class VXfmtmjh : ReadOnlyRecord<VXfmtmjh>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("v_xfmtmjh", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("v_xfmtmjh",schema);
            }
        }
        #endregion
        ...
        public VXfmtmjh(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VXfmtmjh(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VXfmtmjh(string columnName, object columnValue)
        {
            SetSQLProps();
