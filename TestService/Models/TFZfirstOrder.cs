...
{
	/// <summary>
	/// Strongly-typed collection for the TFZfirstOrder class.
	/// </summary>
    [Serializable]
	public partial class TFZfirstOrderCollection : ActiveList<TFZfirstOrder, TFZfirstOrderCollection>
	{	   
		public TFZfirstOrderCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TFZfirstOrderCollection</returns>
		public TFZfirstOrderCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TFZfirstOrder o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_FZfirstOrder table.
	/// </summary>
	[Serializable]
	public partial class TFZfirstOrder : ActiveRecord<TFZfirstOrder>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TFZfirstOrder()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TFZfirstOrder(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TFZfirstOrder(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TFZfirstOrder(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_FZfirstOrder", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_FZfirstOrder",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varPkid,string varCustomerId,DateTime? varBeginTime,string varCoatCode,string varNum,int? varTypeT,string varGylx,int? varOrder,string varResource)
		{
		...
		/// </summary>
		public static void Update(int varPkid,string varCustomerId,DateTime? varBeginTime,string varCoatCode,string varNum,int? varTypeT,string varGylx,int? varOrder,string varResource)
		{
			TFZfirstOrder item = new TFZfirstOrder();
