...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the VOderArtHour class.
    /// </summary>
    [Serializable]
    public partial class VOderArtHourCollection : ReadOnlyList<VOderArtHour, VOderArtHourCollection>
    {        
        public VOderArtHourCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_OderArtHour view.
    /// </summary>
    [Serializable]
    public partial class VOderArtHour : ReadOnlyRecord<VOderArtHour>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_OderArtHour", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                TableSchema.TableColumn colvarShortBy = new TableSchema.TableColumn(schema);
                colvarShortBy.ColumnName = "shortBy";
                colvarShortBy.DataType = DbType.Int32;
                colvarShortBy.MaxLength = 0;
                colvarShortBy.AutoIncrement = false;
                colvarShortBy.IsNullable = true;
                colvarShortBy.IsPrimaryKey = false;
                colvarShortBy.IsForeignKey = false;
                colvarShortBy.IsReadOnly = false;
                
                schema.Columns.Add(colvarShortBy);
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_OderArtHour",schema);
            }
        }
        #endregion
        ...
        public VOderArtHour(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOderArtHour(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOderArtHour(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        [XmlAttribute("ShortBy")]
        [Bindable(true)]
        public int? ShortBy 
	    {
		    get
		    {
			    return GetColumnValue<int?>("shortBy");
		    }
            set 
		    {
			    SetColumnValue("shortBy", value);
            }
        }
	    ...
	    public struct Columns
	    {
            ...
            public static string ShortBy = @"shortBy";
