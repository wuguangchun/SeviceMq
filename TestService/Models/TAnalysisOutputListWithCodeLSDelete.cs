...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOutputListWithCodeLSDelete class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOutputListWithCodeLSDeleteCollection : ActiveList<TAnalysisOutputListWithCodeLSDelete, TAnalysisOutputListWithCodeLSDeleteCollection>
	{	   
		public TAnalysisOutputListWithCodeLSDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOutputListWithCodeLSDeleteCollection</returns>
		public TAnalysisOutputListWithCodeLSDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOutputListWithCodeLSDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OutputListWithCodeLS_delete table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOutputListWithCodeLSDelete : ActiveRecord<TAnalysisOutputListWithCodeLSDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOutputListWithCodeLSDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOutputListWithCodeLSDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOutputListWithCodeLSDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOutputListWithCodeLSDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OutputListWithCodeLS_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OutputListWithCodeLS_delete",schema);
			}
		}
		#endregion
