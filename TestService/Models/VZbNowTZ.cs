...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the VZbNowTZ class.
    /// </summary>
    [Serializable]
    public partial class VZbNowTZCollection : ReadOnlyList<VZbNowTZ, VZbNowTZCollection>
    {        
        public VZbNowTZCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_ZbNowTZ view.
    /// </summary>
    [Serializable]
    public partial class VZbNowTZ : ReadOnlyRecord<VZbNowTZ>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_ZbNowTZ", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_ZbNowTZ",schema);
            }
        }
        #endregion
        ...
        public VZbNowTZ(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VZbNowTZ(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VZbNowTZ(string columnName, object columnValue)
        {
            SetSQLProps();
