...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOutputListWithCodeCopyTestDelete class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOutputListWithCodeCopyTestDeleteCollection : ActiveList<TAnalysisOutputListWithCodeCopyTestDelete, TAnalysisOutputListWithCodeCopyTestDeleteCollection>
	{	   
		public TAnalysisOutputListWithCodeCopyTestDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOutputListWithCodeCopyTestDeleteCollection</returns>
		public TAnalysisOutputListWithCodeCopyTestDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOutputListWithCodeCopyTestDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OutputListWithCode_copyTest_delete table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOutputListWithCodeCopyTestDelete : ActiveRecord<TAnalysisOutputListWithCodeCopyTestDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOutputListWithCodeCopyTestDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOutputListWithCodeCopyTestDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOutputListWithCodeCopyTestDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOutputListWithCodeCopyTestDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OutputListWithCode_copyTest_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				colvarCjTime.DataType = DbType.DateTime;
				colvarCjTime.MaxLength = 0;
				...
				TableSchema.TableColumn colvarFzTime = new TableSchema.TableColumn(schema);
				colvarFzTime.ColumnName = "fzTime";
				colvarFzTime.DataType = DbType.DateTime;
				colvarFzTime.MaxLength = 0;
				colvarFzTime.AutoIncrement = false;
				colvarFzTime.IsNullable = true;
				colvarFzTime.IsPrimaryKey = false;
				colvarFzTime.IsForeignKey = false;
				colvarFzTime.IsReadOnly = false;
				colvarFzTime.DefaultSetting = @"";
				colvarFzTime.ForeignKeyTableName = "";
				schema.Columns.Add(colvarFzTime);
				
				TableSchema.TableColumn colvarZtTime = new TableSchema.TableColumn(schema);
				colvarZtTime.ColumnName = "ztTime";
				colvarZtTime.DataType = DbType.DateTime;
				colvarZtTime.MaxLength = 0;
				colvarZtTime.AutoIncrement = false;
				colvarZtTime.IsNullable = true;
				colvarZtTime.IsPrimaryKey = false;
				colvarZtTime.IsForeignKey = false;
				colvarZtTime.IsReadOnly = false;
				colvarZtTime.DefaultSetting = @"";
				colvarZtTime.ForeignKeyTableName = "";
				schema.Columns.Add(colvarZtTime);
				
				TableSchema.TableColumn colvarBzTime = new TableSchema.TableColumn(schema);
				colvarBzTime.ColumnName = "bzTime";
				colvarBzTime.DataType = DbType.DateTime;
				colvarBzTime.MaxLength = 0;
				colvarBzTime.AutoIncrement = false;
				colvarBzTime.IsNullable = true;
				colvarBzTime.IsPrimaryKey = false;
				colvarBzTime.IsForeignKey = false;
				colvarBzTime.IsReadOnly = false;
				colvarBzTime.DefaultSetting = @"";
				colvarBzTime.ForeignKeyTableName = "";
				schema.Columns.Add(colvarBzTime);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OutputListWithCode_copyTest_delete",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<DateTime?>(Columns.CjTime); }
			set { SetColumnValue(Columns.CjTime, value); }
		}
		  
		[XmlAttribute("FzTime")]
		[Bindable(true)]
		public DateTime? FzTime 
		{
			get { return GetColumnValue<DateTime?>(Columns.FzTime); }
			set { SetColumnValue(Columns.FzTime, value); }
		}
		...
		{
			get { return GetColumnValue<DateTime?>(Columns.ZtTime); }
			set { SetColumnValue(Columns.ZtTime, value); }
		}
		  
		[XmlAttribute("BzTime")]
		[Bindable(true)]
		public DateTime? BzTime 
		{
			get { return GetColumnValue<DateTime?>(Columns.BzTime); }
			set { SetColumnValue(Columns.BzTime, value); }
		}
		...
		/// </summary>
		public static void Insert(string varPkId,string varPlanId,string varJobCode,string varProject,string varOrderType,string varCoatType,string varBodyType,string varFabric,DateTime? varOrderTime,DateTime? varDeliveryTime,int? varSpecialTime,string varSpecialCode,string varStyles,string varStylesResult,int? varNumbers,int? varPlanNum,string varSupportingWay,int? varWorkinfo,string varOrderNo,string varCustomer,string varOriginalCode,string varAbnormal,string varNote,string varResources,DateTime? varBeginTime,DateTime? varEndTime,string varMakeTime,DateTime? varCreateDate,string varScjhdd,string varScggdh,string varScgcdm,string varClothType,string varTzecode,DateTime? varCjTime,DateTime? varFzTime,DateTime? varZtTime,DateTime? varBzTime)
		{
			TAnalysisOutputListWithCodeCopyTestDelete item = new TAnalysisOutputListWithCodeCopyTestDelete();
			...
			item.FzTime = varFzTime;
			
			item.ZtTime = varZtTime;
			
			item.BzTime = varBzTime;
        ...
        public static TableSchema.TableColumn FzTimeColumn
        {
        ...
        public static TableSchema.TableColumn ZtTimeColumn
        {
        ...
        public static TableSchema.TableColumn BzTimeColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string FzTime = @"fzTime";
			 public static string ZtTime = @"ztTime";
			 public static string BzTime = @"bzTime";
