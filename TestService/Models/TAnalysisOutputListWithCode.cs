...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOutputListWithCode class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOutputListWithCodeCollection : ActiveList<TAnalysisOutputListWithCode, TAnalysisOutputListWithCodeCollection>
	{	   
		public TAnalysisOutputListWithCodeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOutputListWithCodeCollection</returns>
		public TAnalysisOutputListWithCodeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOutputListWithCode o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OutputListWithCode table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOutputListWithCode : ActiveRecord<TAnalysisOutputListWithCode>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOutputListWithCode()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOutputListWithCode(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOutputListWithCode(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOutputListWithCode(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OutputListWithCode", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OutputListWithCode",schema);
			}
		}
		#endregion
