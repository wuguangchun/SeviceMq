...
{
    /// <summary>
    /// Controller class for T_fzthirdOrder_delete
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class TFzthirdOrderDeleteController
    {
        // Preload our schema..
        TFzthirdOrderDelete thisSchemaLoad = new TFzthirdOrderDelete();
        ...
        public TFzthirdOrderDeleteCollection FetchAll()
        {
            TFzthirdOrderDeleteCollection coll = new TFzthirdOrderDeleteCollection();
            Query qry = new Query(TFzthirdOrderDelete.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TFzthirdOrderDeleteCollection FetchByID(object OrderId)
        {
            TFzthirdOrderDeleteCollection coll = new TFzthirdOrderDeleteCollection().Where("orderId", OrderId).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public TFzthirdOrderDeleteCollection FetchByQuery(Query qry)
        {
            TFzthirdOrderDeleteCollection coll = new TFzthirdOrderDeleteCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (TFzthirdOrderDelete.Delete(OrderId) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object OrderId)
        {
            return (TFzthirdOrderDelete.Destroy(OrderId) == 1);
        }
