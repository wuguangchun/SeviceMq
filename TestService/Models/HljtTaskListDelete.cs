...
{
	/// <summary>
	/// Strongly-typed collection for the HljtTaskListDelete class.
	/// </summary>
    [Serializable]
	public partial class HljtTaskListDeleteCollection : ActiveList<HljtTaskListDelete, HljtTaskListDeleteCollection>
	{	   
		public HljtTaskListDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>HljtTaskListDeleteCollection</returns>
		public HljtTaskListDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                HljtTaskListDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the HLJT_TaskList_delete table.
	/// </summary>
	[Serializable]
	public partial class HljtTaskListDelete : ActiveRecord<HljtTaskListDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public HljtTaskListDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public HljtTaskListDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public HljtTaskListDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public HljtTaskListDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("HLJT_TaskList_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("HLJT_TaskList_delete",schema);
			}
		}
		#endregion
