...
{
    /// <summary>
    /// Controller class for T_Analysis_OutputListWithCode_copyTest_delete
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class TAnalysisOutputListWithCodeCopyTestDeleteController
    {
        // Preload our schema..
        TAnalysisOutputListWithCodeCopyTestDelete thisSchemaLoad = new TAnalysisOutputListWithCodeCopyTestDelete();
        ...
        public TAnalysisOutputListWithCodeCopyTestDeleteCollection FetchAll()
        {
            TAnalysisOutputListWithCodeCopyTestDeleteCollection coll = new TAnalysisOutputListWithCodeCopyTestDeleteCollection();
            Query qry = new Query(TAnalysisOutputListWithCodeCopyTestDelete.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TAnalysisOutputListWithCodeCopyTestDeleteCollection FetchByID(object PkId)
        {
            TAnalysisOutputListWithCodeCopyTestDeleteCollection coll = new TAnalysisOutputListWithCodeCopyTestDeleteCollection().Where("pkId", PkId).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public TAnalysisOutputListWithCodeCopyTestDeleteCollection FetchByQuery(Query qry)
        {
            TAnalysisOutputListWithCodeCopyTestDeleteCollection coll = new TAnalysisOutputListWithCodeCopyTestDeleteCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (TAnalysisOutputListWithCodeCopyTestDelete.Delete(PkId) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object PkId)
        {
            return (TAnalysisOutputListWithCodeCopyTestDelete.Destroy(PkId) == 1);
        }
