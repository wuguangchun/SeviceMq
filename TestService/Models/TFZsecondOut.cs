...
{
	/// <summary>
	/// Strongly-typed collection for the TFZsecondOut class.
	/// </summary>
    [Serializable]
	public partial class TFZsecondOutCollection : ActiveList<TFZsecondOut, TFZsecondOutCollection>
	{	   
		public TFZsecondOutCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TFZsecondOutCollection</returns>
		public TFZsecondOutCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TFZsecondOut o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_FZsecondOut table.
	/// </summary>
	[Serializable]
	public partial class TFZsecondOut : ActiveRecord<TFZsecondOut>, IActiveRecord
	{
		...
		public TFZsecondOut(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TFZsecondOut(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TFZsecondOut(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_FZsecondOut", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_FZsecondOut",schema);
			}
		}
		#endregion
