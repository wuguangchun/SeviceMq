...
{
	/// <summary>
	/// Strongly-typed collection for the WmsSyncCutterAPSDelete class.
	/// </summary>
    [Serializable]
	public partial class WmsSyncCutterAPSDeleteCollection : ActiveList<WmsSyncCutterAPSDelete, WmsSyncCutterAPSDeleteCollection>
	{	   
		public WmsSyncCutterAPSDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>WmsSyncCutterAPSDeleteCollection</returns>
		public WmsSyncCutterAPSDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                WmsSyncCutterAPSDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the WMS_SYNC_CutterAPS_delete table.
	/// </summary>
	[Serializable]
	public partial class WmsSyncCutterAPSDelete : ActiveRecord<WmsSyncCutterAPSDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public WmsSyncCutterAPSDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public WmsSyncCutterAPSDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public WmsSyncCutterAPSDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public WmsSyncCutterAPSDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WMS_SYNC_CutterAPS_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("WMS_SYNC_CutterAPS_delete",schema);
			}
		}
		#endregion
