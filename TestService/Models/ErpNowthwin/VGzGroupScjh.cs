...
namespace OracleDataDomain{
    /// <summary>
    /// Strongly-typed collection for the VGzGroupScjh class.
    /// </summary>
    [Serializable]
    public partial class VGzGroupScjhCollection : ReadOnlyList<VGzGroupScjh, VGzGroupScjhCollection>
    {        
        public VGzGroupScjhCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_GZ_GROUP_SCJH view.
    /// </summary>
    [Serializable]
    public partial class VGzGroupScjh : ReadOnlyRecord<VGzGroupScjh>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_GZ_GROUP_SCJH", TableType.View, DataService.GetInstance("ErpNowthwin"));
                ...
                DataService.Providers["ErpNowthwin"].AddSchema("V_GZ_GROUP_SCJH",schema);
            }
        }
        #endregion
        ...
        public VGzGroupScjh(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VGzGroupScjh(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VGzGroupScjh(string columnName, object columnValue)
        {
            SetSQLProps();
