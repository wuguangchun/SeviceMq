...
namespace OracleDataDomain
{
	...
	public partial class SCT26 : ActiveRecord<SCT26>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT26", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT26",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(DateTime? varSctcrq,string varSczsbh,string varScgcdm,DateTime? varScxdrq,DateTime? varSccjjq,DateTime? varScfzjq,DateTime? varScjhrq,string varScjhry,string varSczsbz,string varSczszt,string varScjqsm,DateTime? varScjqrq,DateTime? varSclrrq,string varSclrry,DateTime? varScshrq,string varScshry,DateTime? varScztjq,DateTime? varScbzjq,string varSchtbh)
		{
			SCT26 item = new SCT26();
