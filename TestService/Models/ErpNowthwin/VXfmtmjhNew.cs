...
namespace OracleDataDomain{
    /// <summary>
    /// Strongly-typed collection for the VXfmtmjhNew class.
    /// </summary>
    [Serializable]
    public partial class VXfmtmjhNewCollection : ReadOnlyList<VXfmtmjhNew, VXfmtmjhNewCollection>
    {        
        public VXfmtmjhNewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_XFMTMJH_NEW view.
    /// </summary>
    [Serializable]
    public partial class VXfmtmjhNew : ReadOnlyRecord<VXfmtmjhNew>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_XFMTMJH_NEW", TableType.View, DataService.GetInstance("ErpNowthwin"));
                ...
                DataService.Providers["ErpNowthwin"].AddSchema("V_XFMTMJH_NEW",schema);
            }
        }
        #endregion
        ...
        public VXfmtmjhNew(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VXfmtmjhNew(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VXfmtmjhNew(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public string Xskhzb 
	    {
		    get
		    {
			    return GetColumnValue<string>("XSKHZB");
		    }
            set 
		    {
			    SetColumnValue("XSKHZB", value);
            }
        }
