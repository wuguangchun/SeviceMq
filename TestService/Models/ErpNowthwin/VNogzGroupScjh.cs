...
namespace OracleDataDomain{
    /// <summary>
    /// Strongly-typed collection for the VNogzGroupScjh class.
    /// </summary>
    [Serializable]
    public partial class VNogzGroupScjhCollection : ReadOnlyList<VNogzGroupScjh, VNogzGroupScjhCollection>
    {        
        public VNogzGroupScjhCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_NOGZ_GROUP_SCJH view.
    /// </summary>
    [Serializable]
    public partial class VNogzGroupScjh : ReadOnlyRecord<VNogzGroupScjh>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_NOGZ_GROUP_SCJH", TableType.View, DataService.GetInstance("ErpNowthwin"));
                ...
                DataService.Providers["ErpNowthwin"].AddSchema("V_NOGZ_GROUP_SCJH",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VNogzGroupScjh()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VNogzGroupScjh(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VNogzGroupScjh(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VNogzGroupScjh(string columnName, object columnValue)
        {
            SetSQLProps();
