...
{
	/// <summary>
	/// Strongly-typed collection for the SCT12 class.
	/// </summary>
    [Serializable]
	public partial class SCT12Collection : ActiveList<SCT12, SCT12Collection>
	{	   
		public SCT12Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT12Collection</returns>
		public SCT12Collection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT12 table.
	/// </summary>
	[Serializable]
	public partial class SCT12 : ActiveRecord<SCT12>, IActiveRecord
	{
		...
		public SCT12(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT12(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT12", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT12",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varSchtbh,decimal varSchtxh,decimal varScclxh,string varScytdm,string varXttxhm,decimal? varScgxsl,string varScfddm,string varScjgbz)
		{
		...
		/// </summary>
		public static void Update(string varSchtbh,decimal varSchtxh,decimal varScclxh,string varScytdm,string varXttxhm,decimal? varScgxsl,string varScfddm,string varScjgbz)
		{
			SCT12 item = new SCT12();
