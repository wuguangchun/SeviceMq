...
{
	/// <summary>
	/// Strongly-typed collection for the SCT28Ap class.
	/// </summary>
    [Serializable]
	public partial class SCT28ApCollection : ActiveList<SCT28Ap, SCT28ApCollection>
	{	   
		public SCT28ApCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT28ApCollection</returns>
		public SCT28ApCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT28_APS table.
	/// </summary>
	[Serializable]
	public partial class SCT28Ap : ActiveRecord<SCT28Ap>, IActiveRecord
	{
		...
		public SCT28Ap(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT28Ap(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT28_APS", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT28_APS",schema);
			}
		}
		#endregion
