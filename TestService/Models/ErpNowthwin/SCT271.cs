...
{
	/// <summary>
	/// Strongly-typed collection for the SCT271 class.
	/// </summary>
    [Serializable]
	public partial class SCT271Collection : ActiveList<SCT271, SCT271Collection>
	{	   
		public SCT271Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT271Collection</returns>
		public SCT271Collection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT271 table.
	/// </summary>
	[Serializable]
	public partial class SCT271 : ActiveRecord<SCT271>, IActiveRecord
	{
		...
		public SCT271(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT271(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT271", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT271",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varSczsbh,string varSchtbh,string varXtwpks,string varXtwpys,string varXtxmdm,decimal? varScptsl,string varScksms,string varScbldp,string varSccmms)
		{
		...
		/// </summary>
		public static void Update(string varSczsbh,string varSchtbh,string varXtwpks,string varXtwpys,string varXtxmdm,decimal? varScptsl,string varScksms,string varScbldp,string varSccmms)
		{
			SCT271 item = new SCT271();
