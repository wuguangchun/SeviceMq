...
{
	/// <summary>
	/// Strongly-typed collection for the SCT27Ap class.
	/// </summary>
    [Serializable]
	public partial class SCT27ApCollection : ActiveList<SCT27Ap, SCT27ApCollection>
	{	   
		public SCT27ApCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT27ApCollection</returns>
		public SCT27ApCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT27_APS table.
	/// </summary>
	[Serializable]
	public partial class SCT27Ap : ActiveRecord<SCT27Ap>, IActiveRecord
	{
		...
		public SCT27Ap(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT27Ap(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT27_APS", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT27_APS",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varSczsbh,string varSchtbh,decimal varSchtxh,string varScggdh,decimal varScggxh,string varXtwpks,string varXtwpys,string varXtxmdm,decimal? varSczssl,string varSczsbz,string varSczsph,string varScgybz,string varScdlzt,string varScddbz,string varFzfl)
		{
		...
		/// </summary>
		public static void Update(string varSczsbh,string varSchtbh,decimal varSchtxh,string varScggdh,decimal varScggxh,string varXtwpks,string varXtwpys,string varXtxmdm,decimal? varSczssl,string varSczsbz,string varSczsph,string varScgybz,string varScdlzt,string varScddbz,string varFzfl)
		{
			SCT27Ap item = new SCT27Ap();
