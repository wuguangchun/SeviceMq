...
{
	/// <summary>
	/// Strongly-typed collection for the ZYM01 class.
	/// </summary>
    [Serializable]
	public partial class ZYM01Collection : ActiveList<ZYM01, ZYM01Collection>
	{	   
		public ZYM01Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ZYM01Collection</returns>
		public ZYM01Collection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ZYM01 table.
	/// </summary>
	[Serializable]
	public partial class ZYM01 : ActiveRecord<ZYM01>, IActiveRecord
	{
		...
		public ZYM01(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ZYM01(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ZYM01", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("ZYM01",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varXtyhdm,string varXttxhm)
		{
		...
		/// </summary>
		public static void Update(string varXtyhdm,string varXttxhm)
		{
			ZYM01 item = new ZYM01();
