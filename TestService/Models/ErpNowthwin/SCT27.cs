...
namespace OracleDataDomain
{
	...
	public partial class SCT27 : ActiveRecord<SCT27>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT27", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				colvarScdlzt.DataType = DbType.String;
				...
				colvarScddbz.DataType = DbType.String;
				...
				colvarScddcx.DataType = DbType.String;
				colvarScddcx.MaxLength = 20;
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT27",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varScgybz,string varScdlzt,string varScddbz,string varFzfl,string varScddcx,string varSczsbh,string varSchtbh,decimal varSchtxh,string varScggdh,decimal varScggxh,string varXtwpks,string varXtwpys,string varXtxmdm,decimal? varSczssl,string varSczsbz,string varSczsph)
		{
		...
		/// </summary>
		public static void Update(string varScgybz,string varScdlzt,string varScddbz,string varFzfl,string varScddcx,string varSczsbh,string varSchtbh,decimal varSchtxh,string varScggdh,decimal varScggxh,string varXtwpks,string varXtwpys,string varXtxmdm,decimal? varSczssl,string varSczsbz,string varSczsph)
		{
			SCT27 item = new SCT27();
