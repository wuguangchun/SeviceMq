...
namespace OracleDataDomain{
    ...
    public partial class VXfmtmjh : ReadOnlyRecord<VXfmtmjh>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_XFMTMJH", TableType.View, DataService.GetInstance("ErpNowthwin"));
                ...
                DataService.Providers["ErpNowthwin"].AddSchema("V_XFMTMJH",schema);
            }
        }
        #endregion
