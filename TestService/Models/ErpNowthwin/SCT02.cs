...
namespace OracleDataDomain
{
	...
	public partial class SCT02 : ActiveRecord<SCT02>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT02", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT02",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varXtwpks,string varXtwpys,decimal varScclxh,string varScytdm,string varXttxhm,decimal? varScgxsl,string varScfddm,string varScjgbz)
		{
		...
		/// </summary>
		public static void Update(string varXtwpks,string varXtwpys,decimal varScclxh,string varScytdm,string varXttxhm,decimal? varScgxsl,string varScfddm,string varScjgbz)
		{
			SCT02 item = new SCT02();
