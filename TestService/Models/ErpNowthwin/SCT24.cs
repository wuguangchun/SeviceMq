...
namespace OracleDataDomain{
    /// <summary>
    /// Strongly-typed collection for the SCT24 class.
    /// </summary>
    [Serializable]
    public partial class SCT24Collection : ReadOnlyList<SCT24, SCT24Collection>
    {        
        public SCT24Collection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the SCT24 view.
    /// </summary>
    [Serializable]
    public partial class SCT24 : ReadOnlyRecord<SCT24>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("SCT24", TableType.View, DataService.GetInstance("ErpNowthwin"));
                ...
                DataService.Providers["ErpNowthwin"].AddSchema("SCT24",schema);
            }
        }
        #endregion
        ...
        public SCT24(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public SCT24(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public SCT24(string columnName, object columnValue)
        {
            SetSQLProps();
