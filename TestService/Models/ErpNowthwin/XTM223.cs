...
{
	/// <summary>
	/// Strongly-typed collection for the XTM223 class.
	/// </summary>
    [Serializable]
	public partial class XTM223Collection : ActiveList<XTM223, XTM223Collection>
	{	   
		public XTM223Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>XTM223Collection</returns>
		public XTM223Collection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the XTM223 table.
	/// </summary>
	[Serializable]
	public partial class XTM223 : ActiveRecord<XTM223>, IActiveRecord
	{
		...
		public XTM223(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public XTM223(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("XTM223", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("XTM223",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(string varXtwpdm,string varXtwpmc,string varXtpzgg,string varXtwpxh,string varXttxhm,string varXtcwhs,string varKcjldw,string varCgjldw,string varXsjldw,string varCwjldw,string varKcpcgl,string varKcqsck,string varWpjyxm,decimal? varWphsjg,decimal? varWpryxq,decimal? varWpjcts,decimal? varWpxsdj,decimal? varWpkcje,string varWpmjbz,string varXttjbz,string varXtscsx,string varXtlybz,string varXtplgz,decimal? varXtplsl,decimal? varCgtqts,string varCgwldm,decimal? varWpcgdj,string varXtwphh,string varWpbcsh,string varWpgfsh,string varScjldw,string varXtdwbz,decimal? varXtscsh,decimal? varXtzhsh,string varWpxgsx,string varWpjylb,decimal? varWpcgsl,string varWpskbz,string varWpjybh,decimal? varCgkchs,decimal? varKcschs,string varXtcllb)
		{
			XTM223 item = new XTM223();
