...
{
	/// <summary>
	/// Strongly-typed collection for the SCT812 class.
	/// </summary>
    [Serializable]
	public partial class SCT812Collection : ActiveList<SCT812, SCT812Collection>
	{	   
		public SCT812Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT812Collection</returns>
		public SCT812Collection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT812 table.
	/// </summary>
	[Serializable]
	public partial class SCT812 : ActiveRecord<SCT812>, IActiveRecord
	{
		...
		public SCT812(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT812(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT812", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				TableSchema.TableColumn colvarScptxh = new TableSchema.TableColumn(schema);
				colvarScptxh.ColumnName = "SCPTXH";
				colvarScptxh.DataType = DbType.Decimal;
				colvarScptxh.MaxLength = 0;
				colvarScptxh.AutoIncrement = false;
				colvarScptxh.IsNullable = false;
				colvarScptxh.IsPrimaryKey = true;
				colvarScptxh.IsForeignKey = false;
				colvarScptxh.IsReadOnly = false;
				colvarScptxh.DefaultSetting = @"";
				colvarScptxh.ForeignKeyTableName = "";
				schema.Columns.Add(colvarScptxh);
				
				TableSchema.TableColumn colvarScptks = new TableSchema.TableColumn(schema);
				colvarScptks.ColumnName = "SCPTKS";
				colvarScptks.DataType = DbType.String;
				colvarScptks.MaxLength = 20;
				colvarScptks.AutoIncrement = false;
				colvarScptks.IsNullable = true;
				colvarScptks.IsPrimaryKey = false;
				colvarScptks.IsForeignKey = false;
				colvarScptks.IsReadOnly = false;
				colvarScptks.DefaultSetting = @"";
				colvarScptks.ForeignKeyTableName = "";
				schema.Columns.Add(colvarScptks);
				
				TableSchema.TableColumn colvarScptys = new TableSchema.TableColumn(schema);
				colvarScptys.ColumnName = "SCPTYS";
				colvarScptys.DataType = DbType.String;
				colvarScptys.MaxLength = 20;
				colvarScptys.AutoIncrement = false;
				colvarScptys.IsNullable = true;
				colvarScptys.IsPrimaryKey = false;
				colvarScptys.IsForeignKey = false;
				colvarScptys.IsReadOnly = false;
				colvarScptys.DefaultSetting = @"";
				colvarScptys.ForeignKeyTableName = "";
				schema.Columns.Add(colvarScptys);
				
				TableSchema.TableColumn colvarScptxm = new TableSchema.TableColumn(schema);
				colvarScptxm.ColumnName = "SCPTXM";
				colvarScptxm.DataType = DbType.String;
				colvarScptxm.MaxLength = 10;
				colvarScptxm.AutoIncrement = false;
				colvarScptxm.IsNullable = true;
				colvarScptxm.IsPrimaryKey = false;
				colvarScptxm.IsForeignKey = false;
				colvarScptxm.IsReadOnly = false;
				colvarScptxm.DefaultSetting = @"";
				colvarScptxm.ForeignKeyTableName = "";
				schema.Columns.Add(colvarScptxm);
				
				TableSchema.TableColumn colvarScptbl = new TableSchema.TableColumn(schema);
				colvarScptbl.ColumnName = "SCPTBL";
				colvarScptbl.DataType = DbType.Decimal;
				colvarScptbl.MaxLength = 0;
				colvarScptbl.AutoIncrement = false;
				colvarScptbl.IsNullable = true;
				colvarScptbl.IsPrimaryKey = false;
				colvarScptbl.IsForeignKey = false;
				colvarScptbl.IsReadOnly = false;
				colvarScptbl.DefaultSetting = @"";
				colvarScptbl.ForeignKeyTableName = "";
				schema.Columns.Add(colvarScptbl);
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT812",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("Scptxh")]
		[Bindable(true)]
		public decimal Scptxh 
		{
			get { return GetColumnValue<decimal>(Columns.Scptxh); }
			set { SetColumnValue(Columns.Scptxh, value); }
		}
		  
		[XmlAttribute("Scptks")]
		[Bindable(true)]
		public string Scptks 
		{
			get { return GetColumnValue<string>(Columns.Scptks); }
			set { SetColumnValue(Columns.Scptks, value); }
		}
		  
		[XmlAttribute("Scptys")]
		[Bindable(true)]
		public string Scptys 
		{
			get { return GetColumnValue<string>(Columns.Scptys); }
			set { SetColumnValue(Columns.Scptys, value); }
		}
		  
		[XmlAttribute("Scptxm")]
		[Bindable(true)]
		public string Scptxm 
		{
			get { return GetColumnValue<string>(Columns.Scptxm); }
			set { SetColumnValue(Columns.Scptxm, value); }
		}
		  
		[XmlAttribute("Scptbl")]
		[Bindable(true)]
		public decimal? Scptbl 
		{
			get { return GetColumnValue<decimal?>(Columns.Scptbl); }
			set { SetColumnValue(Columns.Scptbl, value); }
		}
		...
		/// </summary>
		public static void Insert(string varScsfbh,string varSczsbh,string varSchtbh,string varXtwpks,string varXtwpys,string varXtxmdm,decimal varScptxh,string varScptks,string varScptys,string varScptxm,decimal? varScptbl,string varSccpxh)
		{
			...
			item.Scptxh = varScptxh;
			
			item.Scptks = varScptks;
			
			item.Scptys = varScptys;
			
			item.Scptxm = varScptxm;
			
			item.Scptbl = varScptbl;
		...
		/// </summary>
		public static void Update(string varScsfbh,string varSczsbh,string varSchtbh,string varXtwpks,string varXtwpys,string varXtxmdm,decimal varScptxh,string varScptks,string varScptys,string varScptxm,decimal? varScptbl,string varSccpxh)
		{
			SCT812 item = new SCT812();
        ...
        public static TableSchema.TableColumn ScptxhColumn
        {
        ...
        public static TableSchema.TableColumn ScptksColumn
        {
        ...
        public static TableSchema.TableColumn ScptysColumn
        {
        ...
        public static TableSchema.TableColumn ScptxmColumn
        {
        ...
        public static TableSchema.TableColumn ScptblColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string Scptxh = @"SCPTXH";
			 public static string Scptks = @"SCPTKS";
			 public static string Scptys = @"SCPTYS";
			 public static string Scptxm = @"SCPTXM";
			 public static string Scptbl = @"SCPTBL";
