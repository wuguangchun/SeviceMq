...
{
	/// <summary>
	/// Strongly-typed collection for the ZYT03AUTOLOG class.
	/// </summary>
    [Serializable]
	public partial class ZYT03AUTOLOGCollection : ActiveList<ZYT03AUTOLOG, ZYT03AUTOLOGCollection>
	{	   
		public ZYT03AUTOLOGCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ZYT03AUTOLOGCollection</returns>
		public ZYT03AUTOLOGCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ZYT03AUTOLOG o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ZYT03AUTOLOG table.
	/// </summary>
	[Serializable]
	public partial class ZYT03AUTOLOG : ActiveRecord<ZYT03AUTOLOG>, IActiveRecord
	{
		...
		public ZYT03AUTOLOG(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ZYT03AUTOLOG(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ZYT03AUTOLOG(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ZYT03AUTOLOG", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("ZYT03AUTOLOG",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varSchtbho,string varXttxhmo,decimal? varXtzyslo,string varXTYHDM1O,string varInstid,decimal? varXtzysl,string varCreateuser,DateTime? varCreatedate,string varIfdeleted)
		{
		...
		/// </summary>
		public static void Update(string varSchtbho,string varXttxhmo,decimal? varXtzyslo,string varXTYHDM1O,string varInstid,decimal? varXtzysl,string varCreateuser,DateTime? varCreatedate,string varIfdeleted)
		{
			ZYT03AUTOLOG item = new ZYT03AUTOLOG();
