...
{
	/// <summary>
	/// Strongly-typed collection for the SCT22 class.
	/// </summary>
    [Serializable]
	public partial class SCT22Collection : ActiveList<SCT22, SCT22Collection>
	{	   
		public SCT22Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT22Collection</returns>
		public SCT22Collection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT22 table.
	/// </summary>
	[Serializable]
	public partial class SCT22 : ActiveRecord<SCT22>, IActiveRecord
	{
		...
		public SCT22(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT22(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT22", TableType.Table, DataService.GetInstance("ErpNowthwin"));
				...
				DataService.Providers["ErpNowthwin"].AddSchema("SCT22",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varScpjdm,string varSccndm,string varSczsbh,string varSchtbh,decimal varSchtxh,DateTime varScjhrq,decimal? varScapsl,decimal? varSczhsl,string varScddlx,string varSccpdl,string varSctzzt)
		{
		...
		/// </summary>
		public static void Update(string varScpjdm,string varSccndm,string varSczsbh,string varSchtbh,decimal varSchtxh,DateTime varScjhrq,decimal? varScapsl,decimal? varSczhsl,string varScddlx,string varSccpdl,string varSctzzt)
		{
			SCT22 item = new SCT22();
