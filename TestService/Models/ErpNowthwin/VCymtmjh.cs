...
namespace OracleDataDomain{
    /// <summary>
    /// Strongly-typed collection for the VCymtmjh class.
    /// </summary>
    [Serializable]
    public partial class VCymtmjhCollection : ReadOnlyList<VCymtmjh, VCymtmjhCollection>
    {        
        public VCymtmjhCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_CYMTMJH view.
    /// </summary>
    [Serializable]
    public partial class VCymtmjh : ReadOnlyRecord<VCymtmjh>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_CYMTMJH", TableType.View, DataService.GetInstance("ErpNowthwin"));
                ...
                DataService.Providers["ErpNowthwin"].AddSchema("V_CYMTMJH",schema);
            }
        }
        #endregion
        ...
        public VCymtmjh(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VCymtmjh(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VCymtmjh(string columnName, object columnValue)
        {
            SetSQLProps();
