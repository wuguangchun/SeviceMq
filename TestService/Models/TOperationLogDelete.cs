...
{
	/// <summary>
	/// Strongly-typed collection for the TOperationLogDelete class.
	/// </summary>
    [Serializable]
	public partial class TOperationLogDeleteCollection : ActiveList<TOperationLogDelete, TOperationLogDeleteCollection>
	{	   
		public TOperationLogDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TOperationLogDeleteCollection</returns>
		public TOperationLogDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TOperationLogDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Operation_Log_delete table.
	/// </summary>
	[Serializable]
	public partial class TOperationLogDelete : ActiveRecord<TOperationLogDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TOperationLogDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TOperationLogDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TOperationLogDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TOperationLogDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Operation_Log_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Operation_Log_delete",schema);
			}
		}
		#endregion
