...
namespace Model
{
	...
	public partial class TBasisOrderStatus : ActiveRecord<TBasisOrderStatus>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varCustomerId,string varOrderType,string varOrderStatus,DateTime? varCreateDate)
		{
		...
		/// </summary>
		public static void Update(string varCustomerId,string varOrderType,string varOrderStatus,DateTime? varCreateDate)
		{
			TBasisOrderStatus item = new TBasisOrderStatus();
