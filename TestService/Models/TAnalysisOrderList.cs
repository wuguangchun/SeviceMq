...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOrderList class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOrderListCollection : ActiveList<TAnalysisOrderList, TAnalysisOrderListCollection>
	{	   
		public TAnalysisOrderListCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOrderListCollection</returns>
		public TAnalysisOrderListCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOrderList o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OrderList table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOrderList : ActiveRecord<TAnalysisOrderList>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOrderList()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOrderList(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOrderList(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOrderList(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OrderList", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OrderList",schema);
			}
		}
		#endregion
