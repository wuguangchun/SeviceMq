...
namespace APSData
{
	...
	/// </summary>
    [Serializable]
	public partial class TOldApsByCfCollection : ActiveList<TOldApsByCf, TOldApsByCfCollection>
	{	   
        ...
        /// </summary>
        /// <returns>TOldApsByCfCollection</returns>
		public TOldApsByCfCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TOldApsByCf o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_OldApsByCf table.
	/// </summary>
	[Serializable]
	public partial class TOldApsByCf : ActiveRecord<TOldApsByCf>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_OldApsByCf", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_OldApsByCf",schema);
			}
		}
		#endregion
