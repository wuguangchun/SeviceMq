...
{
	/// <summary>
	/// Strongly-typed collection for the TBasisSpecialList class.
	/// </summary>
    [Serializable]
	public partial class TBasisSpecialListCollection : ActiveList<TBasisSpecialList, TBasisSpecialListCollection>
	{	   
		public TBasisSpecialListCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBasisSpecialListCollection</returns>
		public TBasisSpecialListCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBasisSpecialList o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Basis_SpecialList table.
	/// </summary>
	[Serializable]
	public partial class TBasisSpecialList : ActiveRecord<TBasisSpecialList>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBasisSpecialList()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBasisSpecialList(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBasisSpecialList(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBasisSpecialList(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Basis_SpecialList", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				colvarSpecialCode.MaxLength = 50;
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Basis_SpecialList",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varSpecialName,string varSpecialCode,int? varSpecialTime)
		{
		...
		/// </summary>
		public static void Update(int varId,string varSpecialName,string varSpecialCode,int? varSpecialTime)
		{
			TBasisSpecialList item = new TBasisSpecialList();
