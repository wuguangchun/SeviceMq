...
{
	/// <summary>
	/// Strongly-typed collection for the TPushBlOutputListDelete class.
	/// </summary>
    [Serializable]
	public partial class TPushBlOutputListDeleteCollection : ActiveList<TPushBlOutputListDelete, TPushBlOutputListDeleteCollection>
	{	   
		public TPushBlOutputListDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TPushBlOutputListDeleteCollection</returns>
		public TPushBlOutputListDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TPushBlOutputListDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_PushBlOutputList_delete table.
	/// </summary>
	[Serializable]
	public partial class TPushBlOutputListDelete : ActiveRecord<TPushBlOutputListDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TPushBlOutputListDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TPushBlOutputListDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TPushBlOutputListDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TPushBlOutputListDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_PushBlOutputList_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_PushBlOutputList_delete",schema);
			}
		}
		#endregion
