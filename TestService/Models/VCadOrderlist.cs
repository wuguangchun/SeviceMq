...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the VCadOrderlist class.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistCollection : ReadOnlyList<VCadOrderlist, VCadOrderlistCollection>
    {        
        public VCadOrderlistCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_CAD_ORDERLIST view.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlist : ReadOnlyRecord<VCadOrderlist>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_CAD_ORDERLIST", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_CAD_ORDERLIST",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VCadOrderlist()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VCadOrderlist(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VCadOrderlist(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VCadOrderlist(string columnName, object columnValue)
        {
            SetSQLProps();
