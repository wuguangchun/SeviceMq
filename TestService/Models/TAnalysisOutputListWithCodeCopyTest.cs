...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOutputListWithCodeCopyTest class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOutputListWithCodeCopyTestCollection : ActiveList<TAnalysisOutputListWithCodeCopyTest, TAnalysisOutputListWithCodeCopyTestCollection>
	{	   
		public TAnalysisOutputListWithCodeCopyTestCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOutputListWithCodeCopyTestCollection</returns>
		public TAnalysisOutputListWithCodeCopyTestCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOutputListWithCodeCopyTest o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OutputListWithCode_copyTest table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOutputListWithCodeCopyTest : ActiveRecord<TAnalysisOutputListWithCodeCopyTest>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOutputListWithCodeCopyTest()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOutputListWithCodeCopyTest(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOutputListWithCodeCopyTest(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOutputListWithCodeCopyTest(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OutputListWithCode_copyTest", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OutputListWithCode_copyTest",schema);
			}
		}
		#endregion
