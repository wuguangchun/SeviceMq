...
{
	/// <summary>
	/// Strongly-typed collection for the TTestProcGetPlansDataCYNew class.
	/// </summary>
    [Serializable]
	public partial class TTestProcGetPlansDataCYNewCollection : ActiveList<TTestProcGetPlansDataCYNew, TTestProcGetPlansDataCYNewCollection>
	{	   
		public TTestProcGetPlansDataCYNewCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TTestProcGetPlansDataCYNewCollection</returns>
		public TTestProcGetPlansDataCYNewCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TTestProcGetPlansDataCYNew o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the t_Test_Proc_GetPlansDataCY_New table.
	/// </summary>
	[Serializable]
	public partial class TTestProcGetPlansDataCYNew : ActiveRecord<TTestProcGetPlansDataCYNew>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TTestProcGetPlansDataCYNew()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TTestProcGetPlansDataCYNew(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TTestProcGetPlansDataCYNew(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TTestProcGetPlansDataCYNew(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("t_Test_Proc_GetPlansDataCY_New", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("t_Test_Proc_GetPlansDataCY_New",schema);
			}
		}
		#endregion
