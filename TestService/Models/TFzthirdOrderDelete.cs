...
{
	/// <summary>
	/// Strongly-typed collection for the TFzthirdOrderDelete class.
	/// </summary>
    [Serializable]
	public partial class TFzthirdOrderDeleteCollection : ActiveList<TFzthirdOrderDelete, TFzthirdOrderDeleteCollection>
	{	   
		public TFzthirdOrderDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TFzthirdOrderDeleteCollection</returns>
		public TFzthirdOrderDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TFzthirdOrderDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_fzthirdOrder_delete table.
	/// </summary>
	[Serializable]
	public partial class TFzthirdOrderDelete : ActiveRecord<TFzthirdOrderDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TFzthirdOrderDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TFzthirdOrderDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TFzthirdOrderDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TFzthirdOrderDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_fzthirdOrder_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				colvarTime.DataType = DbType.String;
				colvarTime.MaxLength = 50;
				...
				DataService.Providers["Nowthwin"].AddSchema("T_fzthirdOrder_delete",schema);
			}
		}
		#endregion
		...
		public string Time 
		{
			get { return GetColumnValue<string>(Columns.Time); }
		...
		/// </summary>
		public static void Insert(string varOrderId,string varCustomerId,string varOrderType,string varCoatType,string varBodyType,string varFabric,string varMflxx,DateTime? varOrderTime,DateTime? varDeliveryTime,int? varSpecialTime,string varSpecialCode,string varStyles,string varStylesResult,int? varNumbers,string varSupportingWay,string varSizes,string varCustomer,DateTime? varCreateTime,DateTime? varCreateDate,string varPbcd,string varGydm,DateTime? varAudittime,string varSfbcpsy,string varTzecode,string varScggdh,string varValueX,string varTime)
		{
			TFzthirdOrderDelete item = new TFzthirdOrderDelete();
		...
		/// </summary>
		public static void Update(string varOrderId,string varCustomerId,string varOrderType,string varCoatType,string varBodyType,string varFabric,string varMflxx,DateTime? varOrderTime,DateTime? varDeliveryTime,int? varSpecialTime,string varSpecialCode,string varStyles,string varStylesResult,int? varNumbers,string varSupportingWay,string varSizes,string varCustomer,DateTime? varCreateTime,DateTime? varCreateDate,string varPbcd,string varGydm,DateTime? varAudittime,string varSfbcpsy,string varTzecode,string varScggdh,string varValueX,string varTime)
		{
			TFzthirdOrderDelete item = new TFzthirdOrderDelete();
