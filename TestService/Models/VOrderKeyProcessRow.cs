...
namespace APSData{
    /// <summary>
    /// Strongly-typed collection for the VOrderKeyProcessRow class.
    /// </summary>
    [Serializable]
    public partial class VOrderKeyProcessRowCollection : ReadOnlyList<VOrderKeyProcessRow, VOrderKeyProcessRowCollection>
    {        
        public VOrderKeyProcessRowCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_OrderKeyProcessRow view.
    /// </summary>
    [Serializable]
    public partial class VOrderKeyProcessRow : ReadOnlyRecord<VOrderKeyProcessRow>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_OrderKeyProcessRow", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_OrderKeyProcessRow",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOrderKeyProcessRow()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOrderKeyProcessRow(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOrderKeyProcessRow(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOrderKeyProcessRow(string columnName, object columnValue)
        {
            SetSQLProps();
