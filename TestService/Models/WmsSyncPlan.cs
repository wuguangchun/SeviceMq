...
namespace Model
{
	...
	public partial class WmsSyncPlan : ActiveRecord<WmsSyncPlan>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WMS_SYNC_plans", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("WMS_SYNC_plans",schema);
			}
		}
		#endregion
