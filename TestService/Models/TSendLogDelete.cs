...
{
	/// <summary>
	/// Strongly-typed collection for the TSendLogDelete class.
	/// </summary>
    [Serializable]
	public partial class TSendLogDeleteCollection : ActiveList<TSendLogDelete, TSendLogDeleteCollection>
	{	   
		public TSendLogDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TSendLogDeleteCollection</returns>
		public TSendLogDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TSendLogDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_sendLog_delete table.
	/// </summary>
	[Serializable]
	public partial class TSendLogDelete : ActiveRecord<TSendLogDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TSendLogDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TSendLogDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TSendLogDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TSendLogDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_sendLog_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_sendLog_delete",schema);
			}
		}
		#endregion
