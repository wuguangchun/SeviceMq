...
namespace Test1
{
	...
	public partial class WmsSyncCutterAP : ActiveRecord<WmsSyncCutterAP>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WMS_SYNC_CutterAPS", TableType.Table, DataService.GetInstance("Test1"));
				...
				DataService.Providers["Test1"].AddSchema("WMS_SYNC_CutterAPS",schema);
			}
		}
		#endregion
