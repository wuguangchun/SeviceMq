...
namespace Test1{
    ...
    public partial class VPlanSDetail : ReadOnlyRecord<VPlanSDetail>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_PlanS_Detail", TableType.View, DataService.GetInstance("Test1"));
                ...
                DataService.Providers["Test1"].AddSchema("V_PlanS_Detail",schema);
            }
        }
        #endregion
