...
namespace Test1
{
	...
	public partial class TCutterAP : ActiveRecord<TCutterAP>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_CutterAPS", TableType.Table, DataService.GetInstance("Test1"));
				...
				DataService.Providers["Test1"].AddSchema("T_CutterAPS",schema);
			}
		}
		#endregion
