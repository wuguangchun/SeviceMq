...
namespace Test1
{
	...
	public partial class TTempInfo : ActiveRecord<TTempInfo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_TempInfo", TableType.Table, DataService.GetInstance("Test1"));
				...
				DataService.Providers["Test1"].AddSchema("T_TempInfo",schema);
			}
		}
		#endregion
