...
namespace Test1
{
	...
	public partial class TTempME : ActiveRecord<TTempME>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_TempMES", TableType.Table, DataService.GetInstance("Test1"));
				...
				DataService.Providers["Test1"].AddSchema("T_TempMES",schema);
			}
		}
		#endregion
