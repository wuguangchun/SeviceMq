...
namespace Test1{
    ...
    public partial class VPlanDetail : ReadOnlyRecord<VPlanDetail>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_Plan_Detail", TableType.View, DataService.GetInstance("Test1"));
                ...
                DataService.Providers["Test1"].AddSchema("V_Plan_Detail",schema);
            }
        }
        #endregion
