...
{
	/// <summary>
	/// Strongly-typed collection for the TTestProcGetPlansDataCYNew1 class.
	/// </summary>
    [Serializable]
	public partial class TTestProcGetPlansDataCYNew1Collection : ActiveList<TTestProcGetPlansDataCYNew1, TTestProcGetPlansDataCYNew1Collection>
	{	   
		public TTestProcGetPlansDataCYNew1Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TTestProcGetPlansDataCYNew1Collection</returns>
		public TTestProcGetPlansDataCYNew1Collection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TTestProcGetPlansDataCYNew1 o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the t_Test_Proc_GetPlansDataCY_New1 table.
	/// </summary>
	[Serializable]
	public partial class TTestProcGetPlansDataCYNew1 : ActiveRecord<TTestProcGetPlansDataCYNew1>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TTestProcGetPlansDataCYNew1()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TTestProcGetPlansDataCYNew1(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TTestProcGetPlansDataCYNew1(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TTestProcGetPlansDataCYNew1(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("t_Test_Proc_GetPlansDataCY_New1", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("t_Test_Proc_GetPlansDataCY_New1",schema);
			}
		}
		#endregion
