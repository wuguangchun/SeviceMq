...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VCadOrderlistBak class.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistBakCollection : ReadOnlyList<VCadOrderlistBak, VCadOrderlistBakCollection>
    {        
        public VCadOrderlistBakCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_CAD_ORDERLIST_BAK view.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistBak : ReadOnlyRecord<VCadOrderlistBak>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_CAD_ORDERLIST_BAK", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_CAD_ORDERLIST_BAK",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VCadOrderlistBak()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VCadOrderlistBak(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VCadOrderlistBak(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VCadOrderlistBak(string columnName, object columnValue)
        {
            SetSQLProps();
