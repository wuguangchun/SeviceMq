...
{
	/// <summary>
	/// Strongly-typed collection for the TPlanSDelete class.
	/// </summary>
    [Serializable]
	public partial class TPlanSDeleteCollection : ActiveList<TPlanSDelete, TPlanSDeleteCollection>
	{	   
		public TPlanSDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TPlanSDeleteCollection</returns>
		public TPlanSDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TPlanSDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_PlanS_delete table.
	/// </summary>
	[Serializable]
	public partial class TPlanSDelete : ActiveRecord<TPlanSDelete>, IActiveRecord
	{
		...
		public TPlanSDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TPlanSDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TPlanSDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_PlanS_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_PlanS_delete",schema);
			}
		}
		#endregion
		...
		{
			TPlanSDelete item = new TPlanSDelete();
