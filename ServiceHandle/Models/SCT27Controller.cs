...
namespace Model
{
    ...
    public partial class SCT27Controller
    {
        ...
        public SCT27Collection FetchByID(object Schtbh)
        {
            SCT27Collection coll = new SCT27Collection().Where("SCHTBH", Schtbh).Load();
            return coll;
        }
        ...
        {
            return (SCT27.Delete(Schtbh) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object Schtbh)
        {
            return (SCT27.Destroy(Schtbh) == 1);
        }
