...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOutputListWithCodeTZShirt class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOutputListWithCodeTZShirtCollection : ActiveList<TAnalysisOutputListWithCodeTZShirt, TAnalysisOutputListWithCodeTZShirtCollection>
	{	   
		public TAnalysisOutputListWithCodeTZShirtCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOutputListWithCodeTZShirtCollection</returns>
		public TAnalysisOutputListWithCodeTZShirtCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOutputListWithCodeTZShirt o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OutputListWithCode_TZShirt table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOutputListWithCodeTZShirt : ActiveRecord<TAnalysisOutputListWithCodeTZShirt>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOutputListWithCodeTZShirt()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOutputListWithCodeTZShirt(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOutputListWithCodeTZShirt(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOutputListWithCodeTZShirt(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OutputListWithCode_TZShirt", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OutputListWithCode_TZShirt",schema);
			}
		}
		#endregion
