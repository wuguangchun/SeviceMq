...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VOrderListCadCy class.
    /// </summary>
    [Serializable]
    public partial class VOrderListCadCyCollection : ReadOnlyList<VOrderListCadCy, VOrderListCadCyCollection>
    {        
        public VOrderListCadCyCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_OrderList_CAD_CY view.
    /// </summary>
    [Serializable]
    public partial class VOrderListCadCy : ReadOnlyRecord<VOrderListCadCy>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_OrderList_CAD_CY", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_OrderList_CAD_CY",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOrderListCadCy()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOrderListCadCy(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOrderListCadCy(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOrderListCadCy(string columnName, object columnValue)
        {
            SetSQLProps();
