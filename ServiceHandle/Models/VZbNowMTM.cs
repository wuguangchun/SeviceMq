...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VZbNowMTM class.
    /// </summary>
    [Serializable]
    public partial class VZbNowMTMCollection : ReadOnlyList<VZbNowMTM, VZbNowMTMCollection>
    {        
        public VZbNowMTMCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_ZbNowMTM view.
    /// </summary>
    [Serializable]
    public partial class VZbNowMTM : ReadOnlyRecord<VZbNowMTM>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_ZbNowMTM", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_ZbNowMTM",schema);
            }
        }
        #endregion
        ...
        public VZbNowMTM(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VZbNowMTM(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VZbNowMTM(string columnName, object columnValue)
        {
            SetSQLProps();
