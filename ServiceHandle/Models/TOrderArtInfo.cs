...
{
	/// <summary>
	/// Strongly-typed collection for the TOrderArtInfo class.
	/// </summary>
    [Serializable]
	public partial class TOrderArtInfoCollection : ActiveList<TOrderArtInfo, TOrderArtInfoCollection>
	{	   
		public TOrderArtInfoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TOrderArtInfoCollection</returns>
		public TOrderArtInfoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TOrderArtInfo o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_OrderArtInfo table.
	/// </summary>
	[Serializable]
	public partial class TOrderArtInfo : ActiveRecord<TOrderArtInfo>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TOrderArtInfo()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TOrderArtInfo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TOrderArtInfo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TOrderArtInfo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_OrderArtInfo", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				colvarHour.DataType = DbType.AnsiString;
				colvarHour.MaxLength = 8;
				colvarHour.AutoIncrement = false;
				colvarHour.IsNullable = false;
				...
				colvarOrderArtslist.DataType = DbType.AnsiString;
				colvarOrderArtslist.MaxLength = 1024;
				colvarOrderArtslist.AutoIncrement = false;
				colvarOrderArtslist.IsNullable = false;
				...
				DataService.Providers["Nowthwin"].AddSchema("T_OrderArtInfo",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.OrderDetailID); }
		...
		/// </summary>
		public static void Insert(string varOrderDetailID,string varCode,string varHour,string varOrderArtslist)
		{
			TOrderArtInfo item = new TOrderArtInfo();
			
			item.OrderDetailID = varOrderDetailID;
		...
		/// </summary>
		public static void Update(string varOrderDetailID,string varCode,string varHour,string varOrderArtslist)
		{
			TOrderArtInfo item = new TOrderArtInfo();
