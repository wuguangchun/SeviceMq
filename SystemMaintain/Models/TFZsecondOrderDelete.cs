...
{
	/// <summary>
	/// Strongly-typed collection for the TFZsecondOrderDelete class.
	/// </summary>
    [Serializable]
	public partial class TFZsecondOrderDeleteCollection : ActiveList<TFZsecondOrderDelete, TFZsecondOrderDeleteCollection>
	{	   
		public TFZsecondOrderDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TFZsecondOrderDeleteCollection</returns>
		public TFZsecondOrderDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TFZsecondOrderDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_FZsecondOrder_delete table.
	/// </summary>
	[Serializable]
	public partial class TFZsecondOrderDelete : ActiveRecord<TFZsecondOrderDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TFZsecondOrderDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TFZsecondOrderDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TFZsecondOrderDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TFZsecondOrderDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_FZsecondOrder_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_FZsecondOrder_delete",schema);
			}
		}
		#endregion
