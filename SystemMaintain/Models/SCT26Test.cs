...
{
	/// <summary>
	/// Strongly-typed collection for the SCT26Test class.
	/// </summary>
    [Serializable]
	public partial class SCT26TestCollection : ActiveList<SCT26Test, SCT26TestCollection>
	{	   
		public SCT26TestCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT26TestCollection</returns>
		public SCT26TestCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT26_test table.
	/// </summary>
	[Serializable]
	public partial class SCT26Test : ActiveRecord<SCT26Test>, IActiveRecord
	{
		...
		public SCT26Test(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT26Test(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT26_test", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("SCT26_test",schema);
			}
		}
		#endregion
