...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisCyTZJh class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisCyTZJhCollection : ActiveList<TAnalysisCyTZJh, TAnalysisCyTZJhCollection>
	{	   
		public TAnalysisCyTZJhCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisCyTZJhCollection</returns>
		public TAnalysisCyTZJhCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisCyTZJh o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_CyTZJh table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisCyTZJh : ActiveRecord<TAnalysisCyTZJh>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisCyTZJh()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisCyTZJh(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisCyTZJh(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisCyTZJh(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_CyTZJh", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_CyTZJh",schema);
			}
		}
		#endregion
		...
		{
			TAnalysisCyTZJh item = new TAnalysisCyTZJh();
