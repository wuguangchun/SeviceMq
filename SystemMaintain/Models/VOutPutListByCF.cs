...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VOutPutListByCF class.
    /// </summary>
    [Serializable]
    public partial class VOutPutListByCFCollection : ReadOnlyList<VOutPutListByCF, VOutPutListByCFCollection>
    {        
        public VOutPutListByCFCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_outPutListByCF view.
    /// </summary>
    [Serializable]
    public partial class VOutPutListByCF : ReadOnlyRecord<VOutPutListByCF>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_outPutListByCF", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_outPutListByCF",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOutPutListByCF()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOutPutListByCF(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOutPutListByCF(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOutPutListByCF(string columnName, object columnValue)
        {
            SetSQLProps();
