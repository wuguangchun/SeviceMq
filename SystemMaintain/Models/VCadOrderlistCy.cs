...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VCadOrderlistCy class.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistCyCollection : ReadOnlyList<VCadOrderlistCy, VCadOrderlistCyCollection>
    {        
        public VCadOrderlistCyCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_CAD_ORDERLIST_CY view.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistCy : ReadOnlyRecord<VCadOrderlistCy>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_CAD_ORDERLIST_CY", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_CAD_ORDERLIST_CY",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VCadOrderlistCy()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VCadOrderlistCy(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VCadOrderlistCy(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VCadOrderlistCy(string columnName, object columnValue)
        {
            SetSQLProps();
