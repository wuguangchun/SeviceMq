...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the ViewOutputListCF class.
    /// </summary>
    [Serializable]
    public partial class ViewOutputListCFCollection : ReadOnlyList<ViewOutputListCF, ViewOutputListCFCollection>
    {        
        public ViewOutputListCFCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_outputListCF view.
    /// </summary>
    [Serializable]
    public partial class ViewOutputListCF : ReadOnlyRecord<ViewOutputListCF>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_outputListCF", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("View_outputListCF",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewOutputListCF()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewOutputListCF(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewOutputListCF(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewOutputListCF(string columnName, object columnValue)
        {
            SetSQLProps();
