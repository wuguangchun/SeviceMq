...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the View1Delete class.
    /// </summary>
    [Serializable]
    public partial class View1DeleteCollection : ReadOnlyList<View1Delete, View1DeleteCollection>
    {        
        public View1DeleteCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_1_delete view.
    /// </summary>
    [Serializable]
    public partial class View1Delete : ReadOnlyRecord<View1Delete>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_1_delete", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("View_1_delete",schema);
            }
        }
        #endregion
        ...
        public View1Delete(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public View1Delete(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public View1Delete(string columnName, object columnValue)
        {
            SetSQLProps();
