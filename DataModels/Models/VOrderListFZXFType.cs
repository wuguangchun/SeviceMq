...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VOrderListFZXFType class.
    /// </summary>
    [Serializable]
    public partial class VOrderListFZXFTypeCollection : ReadOnlyList<VOrderListFZXFType, VOrderListFZXFTypeCollection>
    {        
        public VOrderListFZXFTypeCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_OrderListFZ_XFType view.
    /// </summary>
    [Serializable]
    public partial class VOrderListFZXFType : ReadOnlyRecord<VOrderListFZXFType>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_OrderListFZ_XFType", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_OrderListFZ_XFType",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOrderListFZXFType()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOrderListFZXFType(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOrderListFZXFType(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOrderListFZXFType(string columnName, object columnValue)
        {
            SetSQLProps();
