...
{
	/// <summary>
	/// Strongly-typed collection for the TLogServiceOld class.
	/// </summary>
    [Serializable]
	public partial class TLogServiceOldCollection : ActiveList<TLogServiceOld, TLogServiceOldCollection>
	{	   
		public TLogServiceOldCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TLogServiceOldCollection</returns>
		public TLogServiceOldCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TLogServiceOld o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Log_Service_old table.
	/// </summary>
	[Serializable]
	public partial class TLogServiceOld : ActiveRecord<TLogServiceOld>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TLogServiceOld()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TLogServiceOld(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TLogServiceOld(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TLogServiceOld(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Log_Service_old", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Log_Service_old",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varId,string varKhdh,string varLable,string varMessagePath,string varCallBackUrl,DateTime? varCreateTime,string varContext,string varMessageID)
		{
