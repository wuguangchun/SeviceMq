...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOutputListWithCodeShirt class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOutputListWithCodeShirtCollection : ActiveList<TAnalysisOutputListWithCodeShirt, TAnalysisOutputListWithCodeShirtCollection>
	{	   
		public TAnalysisOutputListWithCodeShirtCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOutputListWithCodeShirtCollection</returns>
		public TAnalysisOutputListWithCodeShirtCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOutputListWithCodeShirt o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OutputListWithCode_Shirt table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOutputListWithCodeShirt : ActiveRecord<TAnalysisOutputListWithCodeShirt>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOutputListWithCodeShirt()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOutputListWithCodeShirt(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOutputListWithCodeShirt(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOutputListWithCodeShirt(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OutputListWithCode_Shirt", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OutputListWithCode_Shirt",schema);
			}
		}
		#endregion
