...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOutputListWithCodeDelete class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOutputListWithCodeDeleteCollection : ActiveList<TAnalysisOutputListWithCodeDelete, TAnalysisOutputListWithCodeDeleteCollection>
	{	   
		public TAnalysisOutputListWithCodeDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOutputListWithCodeDeleteCollection</returns>
		public TAnalysisOutputListWithCodeDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOutputListWithCodeDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OutputListWithCode_delete table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOutputListWithCodeDelete : ActiveRecord<TAnalysisOutputListWithCodeDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOutputListWithCodeDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOutputListWithCodeDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOutputListWithCodeDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOutputListWithCodeDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OutputListWithCode_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OutputListWithCode_delete",schema);
			}
		}
		#endregion
