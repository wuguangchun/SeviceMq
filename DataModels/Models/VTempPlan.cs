...
namespace Model{
    ...
    public partial class VTempPlan : ReadOnlyRecord<VTempPlan>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_TempPlanS", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_TempPlanS",schema);
            }
        }
        #endregion
