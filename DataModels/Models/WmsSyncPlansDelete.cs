...
{
	/// <summary>
	/// Strongly-typed collection for the WmsSyncPlansDelete class.
	/// </summary>
    [Serializable]
	public partial class WmsSyncPlansDeleteCollection : ActiveList<WmsSyncPlansDelete, WmsSyncPlansDeleteCollection>
	{	   
		public WmsSyncPlansDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>WmsSyncPlansDeleteCollection</returns>
		public WmsSyncPlansDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                WmsSyncPlansDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the WMS_SYNC_plans_delete table.
	/// </summary>
	[Serializable]
	public partial class WmsSyncPlansDelete : ActiveRecord<WmsSyncPlansDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public WmsSyncPlansDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public WmsSyncPlansDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public WmsSyncPlansDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public WmsSyncPlansDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("WMS_SYNC_plans_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("WMS_SYNC_plans_delete",schema);
			}
		}
		#endregion
