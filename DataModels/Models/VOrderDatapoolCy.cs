...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VOrderDatapoolCy class.
    /// </summary>
    [Serializable]
    public partial class VOrderDatapoolCyCollection : ReadOnlyList<VOrderDatapoolCy, VOrderDatapoolCyCollection>
    {        
        public VOrderDatapoolCyCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_OrderDatapoolCy view.
    /// </summary>
    [Serializable]
    public partial class VOrderDatapoolCy : ReadOnlyRecord<VOrderDatapoolCy>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_OrderDatapoolCy", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_OrderDatapoolCy",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOrderDatapoolCy()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOrderDatapoolCy(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOrderDatapoolCy(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOrderDatapoolCy(string columnName, object columnValue)
        {
            SetSQLProps();
