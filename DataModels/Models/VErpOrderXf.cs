...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VErpOrderXf class.
    /// </summary>
    [Serializable]
    public partial class VErpOrderXfCollection : ReadOnlyList<VErpOrderXf, VErpOrderXfCollection>
    {        
        public VErpOrderXfCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_ErpOrderXf view.
    /// </summary>
    [Serializable]
    public partial class VErpOrderXf : ReadOnlyRecord<VErpOrderXf>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_ErpOrderXf", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_ErpOrderXf",schema);
            }
        }
        #endregion
        ...
        public VErpOrderXf(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VErpOrderXf(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VErpOrderXf(string columnName, object columnValue)
        {
            SetSQLProps();
