...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VOrderDatapoolXfTest class.
    /// </summary>
    [Serializable]
    public partial class VOrderDatapoolXfTestCollection : ReadOnlyList<VOrderDatapoolXfTest, VOrderDatapoolXfTestCollection>
    {        
        public VOrderDatapoolXfTestCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_OrderDatapoolXf_Test view.
    /// </summary>
    [Serializable]
    public partial class VOrderDatapoolXfTest : ReadOnlyRecord<VOrderDatapoolXfTest>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_OrderDatapoolXf_Test", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_OrderDatapoolXf_Test",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOrderDatapoolXfTest()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOrderDatapoolXfTest(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOrderDatapoolXfTest(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOrderDatapoolXfTest(string columnName, object columnValue)
        {
            SetSQLProps();
