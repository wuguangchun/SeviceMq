...
{
	/// <summary>
	/// Strongly-typed collection for the TBLDataOrderHistory class.
	/// </summary>
    [Serializable]
	public partial class TBLDataOrderHistoryCollection : ActiveList<TBLDataOrderHistory, TBLDataOrderHistoryCollection>
	{	   
		public TBLDataOrderHistoryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBLDataOrderHistoryCollection</returns>
		public TBLDataOrderHistoryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBLDataOrderHistory o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_BLData_Order@History table.
	/// </summary>
	[Serializable]
	public partial class TBLDataOrderHistory : ActiveRecord<TBLDataOrderHistory>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBLDataOrderHistory()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBLDataOrderHistory(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBLDataOrderHistory(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBLDataOrderHistory(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_BLData_Order@History", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_BLData_Order@History",schema);
			}
		}
		#endregion
