...
{
	/// <summary>
	/// Strongly-typed collection for the TBLDataOrdermx1712 class.
	/// </summary>
    [Serializable]
	public partial class TBLDataOrdermx1712Collection : ActiveList<TBLDataOrdermx1712, TBLDataOrdermx1712Collection>
	{	   
		public TBLDataOrdermx1712Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBLDataOrdermx1712Collection</returns>
		public TBLDataOrdermx1712Collection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBLDataOrdermx1712 o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_BLData_Ordermx@1712 table.
	/// </summary>
	[Serializable]
	public partial class TBLDataOrdermx1712 : ActiveRecord<TBLDataOrdermx1712>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBLDataOrdermx1712()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBLDataOrdermx1712(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBLDataOrdermx1712(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBLDataOrdermx1712(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_BLData_Ordermx@1712", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_BLData_Ordermx@1712",schema);
			}
		}
		#endregion
