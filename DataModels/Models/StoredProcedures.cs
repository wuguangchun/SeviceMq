...
namespace Model{
    public partial class SPs{
        ...
        /// <summary>
        /// Creates an object wrapper for the Proc_GetPlansTZDataCyByDate Procedure
        /// </summary>
        public static StoredProcedure ProcGetPlansTZDataCyByDate(DateTime? BeginTime1)
        {
            SubSonic.StoredProcedure sp = new SubSonic.StoredProcedure("Proc_GetPlansTZDataCyByDate", DataService.GetInstance("Nowthwin"), "dbo");
        	
            sp.Command.AddParameter("@BeginTime1", BeginTime1, DbType.DateTime, null, null);
