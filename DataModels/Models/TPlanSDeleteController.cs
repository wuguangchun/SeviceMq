...
{
    /// <summary>
    /// Controller class for T_PlanS_delete
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class TPlanSDeleteController
    {
        // Preload our schema..
        TPlanSDelete thisSchemaLoad = new TPlanSDelete();
        ...
        public TPlanSDeleteCollection FetchAll()
        {
            TPlanSDeleteCollection coll = new TPlanSDeleteCollection();
            Query qry = new Query(TPlanSDelete.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TPlanSDeleteCollection FetchByID(object Khdh)
        {
            TPlanSDeleteCollection coll = new TPlanSDeleteCollection().Where("KHDH", Khdh).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public TPlanSDeleteCollection FetchByQuery(Query qry)
        {
            TPlanSDeleteCollection coll = new TPlanSDeleteCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (TPlanSDelete.Delete(Khdh) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object Khdh)
        {
            return (TPlanSDelete.Destroy(Khdh) == 1);
        }
