...
{
    /// <summary>
    /// Controller class for T_Analysis_OrderListByCF
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class TAnalysisOrderListByCFController
    {
        // Preload our schema..
        TAnalysisOrderListByCF thisSchemaLoad = new TAnalysisOrderListByCF();
        ...
        public TAnalysisOrderListByCFCollection FetchAll()
        {
            TAnalysisOrderListByCFCollection coll = new TAnalysisOrderListByCFCollection();
            Query qry = new Query(TAnalysisOrderListByCF.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TAnalysisOrderListByCFCollection FetchByID(object OrderId)
        {
            TAnalysisOrderListByCFCollection coll = new TAnalysisOrderListByCFCollection().Where("orderId", OrderId).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public TAnalysisOrderListByCFCollection FetchByQuery(Query qry)
        {
            TAnalysisOrderListByCFCollection coll = new TAnalysisOrderListByCFCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (TAnalysisOrderListByCF.Delete(OrderId) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object OrderId)
        {
            return (TAnalysisOrderListByCF.Destroy(OrderId) == 1);
        }
