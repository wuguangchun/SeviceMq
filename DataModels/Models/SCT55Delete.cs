...
{
	/// <summary>
	/// Strongly-typed collection for the SCT55Delete class.
	/// </summary>
    [Serializable]
	public partial class SCT55DeleteCollection : ActiveList<SCT55Delete, SCT55DeleteCollection>
	{	   
		public SCT55DeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT55DeleteCollection</returns>
		public SCT55DeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SCT55Delete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT55_delete table.
	/// </summary>
	[Serializable]
	public partial class SCT55Delete : ActiveRecord<SCT55Delete>, IActiveRecord
	{
		...
		public SCT55Delete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT55Delete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SCT55Delete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT55_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("SCT55_delete",schema);
			}
		}
		#endregion
