...
{
	/// <summary>
	/// Strongly-typed collection for the TBLDataMflxx1712 class.
	/// </summary>
    [Serializable]
	public partial class TBLDataMflxx1712Collection : ActiveList<TBLDataMflxx1712, TBLDataMflxx1712Collection>
	{	   
		public TBLDataMflxx1712Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBLDataMflxx1712Collection</returns>
		public TBLDataMflxx1712Collection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBLDataMflxx1712 o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_BLData_Mflxx@1712 table.
	/// </summary>
	[Serializable]
	public partial class TBLDataMflxx1712 : ActiveRecord<TBLDataMflxx1712>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBLDataMflxx1712()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBLDataMflxx1712(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBLDataMflxx1712(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBLDataMflxx1712(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_BLData_Mflxx@1712", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_BLData_Mflxx@1712",schema);
			}
		}
		#endregion
