...
{
	/// <summary>
	/// Strongly-typed collection for the TBLDataOrder1712 class.
	/// </summary>
    [Serializable]
	public partial class TBLDataOrder1712Collection : ActiveList<TBLDataOrder1712, TBLDataOrder1712Collection>
	{	   
		public TBLDataOrder1712Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBLDataOrder1712Collection</returns>
		public TBLDataOrder1712Collection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBLDataOrder1712 o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_BLData_Order@1712 table.
	/// </summary>
	[Serializable]
	public partial class TBLDataOrder1712 : ActiveRecord<TBLDataOrder1712>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBLDataOrder1712()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBLDataOrder1712(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBLDataOrder1712(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBLDataOrder1712(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_BLData_Order@1712", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_BLData_Order@1712",schema);
			}
		}
		#endregion
