...
{
	/// <summary>
	/// Strongly-typed collection for the TBLDataMflxxHistory class.
	/// </summary>
    [Serializable]
	public partial class TBLDataMflxxHistoryCollection : ActiveList<TBLDataMflxxHistory, TBLDataMflxxHistoryCollection>
	{	   
		public TBLDataMflxxHistoryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBLDataMflxxHistoryCollection</returns>
		public TBLDataMflxxHistoryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBLDataMflxxHistory o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_BLData_Mflxx@History table.
	/// </summary>
	[Serializable]
	public partial class TBLDataMflxxHistory : ActiveRecord<TBLDataMflxxHistory>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBLDataMflxxHistory()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBLDataMflxxHistory(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBLDataMflxxHistory(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBLDataMflxxHistory(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_BLData_Mflxx@History", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				colvarMflxxid.AutoIncrement = false;
				...
				DataService.Providers["Nowthwin"].AddSchema("T_BLData_Mflxx@History",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varMflxxid,int? varMxid,string varOrderid,string varKhdh,string varYlbm,string varMtml,string varYllx,string varYllxmc,int? varFlagDelete,string varTg,decimal? varMltgkd)
		{
