...
{
    /// <summary>
    /// Controller class for T_Analysis_OrderListByCF@History
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class TAnalysisOrderListByCFHistoryController
    {
        // Preload our schema..
        TAnalysisOrderListByCFHistory thisSchemaLoad = new TAnalysisOrderListByCFHistory();
        ...
        public TAnalysisOrderListByCFHistoryCollection FetchAll()
        {
            TAnalysisOrderListByCFHistoryCollection coll = new TAnalysisOrderListByCFHistoryCollection();
            Query qry = new Query(TAnalysisOrderListByCFHistory.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TAnalysisOrderListByCFHistoryCollection FetchByID(object OrderId)
        {
            TAnalysisOrderListByCFHistoryCollection coll = new TAnalysisOrderListByCFHistoryCollection().Where("orderId", OrderId).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public TAnalysisOrderListByCFHistoryCollection FetchByQuery(Query qry)
        {
            TAnalysisOrderListByCFHistoryCollection coll = new TAnalysisOrderListByCFHistoryCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (TAnalysisOrderListByCFHistory.Delete(OrderId) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object OrderId)
        {
            return (TAnalysisOrderListByCFHistory.Destroy(OrderId) == 1);
        }
