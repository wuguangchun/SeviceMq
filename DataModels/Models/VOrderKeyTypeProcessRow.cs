...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the VOrderKeyTypeProcessRow class.
    /// </summary>
    [Serializable]
    public partial class VOrderKeyTypeProcessRowCollection : ReadOnlyList<VOrderKeyTypeProcessRow, VOrderKeyTypeProcessRowCollection>
    {        
        public VOrderKeyTypeProcessRowCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_OrderKeyTypeProcessRow view.
    /// </summary>
    [Serializable]
    public partial class VOrderKeyTypeProcessRow : ReadOnlyRecord<VOrderKeyTypeProcessRow>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_OrderKeyTypeProcessRow", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_OrderKeyTypeProcessRow",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOrderKeyTypeProcessRow()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOrderKeyTypeProcessRow(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOrderKeyTypeProcessRow(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOrderKeyTypeProcessRow(string columnName, object columnValue)
        {
            SetSQLProps();
