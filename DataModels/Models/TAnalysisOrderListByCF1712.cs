...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOrderListByCF1712 class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOrderListByCF1712Collection : ActiveList<TAnalysisOrderListByCF1712, TAnalysisOrderListByCF1712Collection>
	{	   
		public TAnalysisOrderListByCF1712Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOrderListByCF1712Collection</returns>
		public TAnalysisOrderListByCF1712Collection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOrderListByCF1712 o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OrderListByCF@1712 table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOrderListByCF1712 : ActiveRecord<TAnalysisOrderListByCF1712>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOrderListByCF1712()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOrderListByCF1712(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOrderListByCF1712(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOrderListByCF1712(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OrderListByCF@1712", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OrderListByCF@1712",schema);
			}
		}
		#endregion
