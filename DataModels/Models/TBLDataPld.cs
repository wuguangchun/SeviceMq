...
{
	/// <summary>
	/// Strongly-typed collection for the TBLDataPld class.
	/// </summary>
    [Serializable]
	public partial class TBLDataPldCollection : ActiveList<TBLDataPld, TBLDataPldCollection>
	{	   
		public TBLDataPldCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBLDataPldCollection</returns>
		public TBLDataPldCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_BLData_PLD table.
	/// </summary>
	[Serializable]
	public partial class TBLDataPld : ActiveRecord<TBLDataPld>, IActiveRecord
	{
		...
		public TBLDataPld(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBLDataPld(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBLDataPld(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_BLData_PLD", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_BLData_PLD",schema);
			}
		}
		#endregion
