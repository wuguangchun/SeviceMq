...
{
	/// <summary>
	/// Strongly-typed collection for the SCT02Delete class.
	/// </summary>
    [Serializable]
	public partial class SCT02DeleteCollection : ActiveList<SCT02Delete, SCT02DeleteCollection>
	{	   
		public SCT02DeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SCT02DeleteCollection</returns>
		public SCT02DeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SCT02Delete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SCT02_delete table.
	/// </summary>
	[Serializable]
	public partial class SCT02Delete : ActiveRecord<SCT02Delete>, IActiveRecord
	{
		...
		public SCT02Delete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SCT02Delete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SCT02Delete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SCT02_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("SCT02_delete",schema);
			}
		}
		#endregion
