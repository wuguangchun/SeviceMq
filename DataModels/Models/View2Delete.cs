...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the View2Delete class.
    /// </summary>
    [Serializable]
    public partial class View2DeleteCollection : ReadOnlyList<View2Delete, View2DeleteCollection>
    {        
        public View2DeleteCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_2_delete view.
    /// </summary>
    [Serializable]
    public partial class View2Delete : ReadOnlyRecord<View2Delete>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_2_delete", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("View_2_delete",schema);
            }
        }
        #endregion
        ...
        public View2Delete(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public View2Delete(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public View2Delete(string columnName, object columnValue)
        {
            SetSQLProps();
