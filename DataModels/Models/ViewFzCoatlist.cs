...
namespace Model{
    /// <summary>
    /// Strongly-typed collection for the ViewFzCoatlist class.
    /// </summary>
    [Serializable]
    public partial class ViewFzCoatlistCollection : ReadOnlyList<ViewFzCoatlist, ViewFzCoatlistCollection>
    {        
        public ViewFzCoatlistCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the View_FZ_Coatlist view.
    /// </summary>
    [Serializable]
    public partial class ViewFzCoatlist : ReadOnlyRecord<ViewFzCoatlist>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("View_FZ_Coatlist", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("View_FZ_Coatlist",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewFzCoatlist()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewFzCoatlist(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewFzCoatlist(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewFzCoatlist(string columnName, object columnValue)
        {
            SetSQLProps();
