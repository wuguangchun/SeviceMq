...
namespace Model
{
	...
	public partial class TPlan : ActiveRecord<TPlan>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_PlanS", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_PlanS",schema);
			}
		}
		#endregion
