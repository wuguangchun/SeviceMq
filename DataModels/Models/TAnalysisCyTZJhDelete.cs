...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisCyTZJhDelete class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisCyTZJhDeleteCollection : ActiveList<TAnalysisCyTZJhDelete, TAnalysisCyTZJhDeleteCollection>
	{	   
		public TAnalysisCyTZJhDeleteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisCyTZJhDeleteCollection</returns>
		public TAnalysisCyTZJhDeleteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisCyTZJhDelete o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_CyTZJh_delete table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisCyTZJhDelete : ActiveRecord<TAnalysisCyTZJhDelete>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisCyTZJhDelete()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisCyTZJhDelete(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisCyTZJhDelete(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisCyTZJhDelete(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_CyTZJh_delete", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_CyTZJh_delete",schema);
			}
		}
		#endregion
