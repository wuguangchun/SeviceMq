...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisOrderListByCF class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisOrderListByCFCollection : ActiveList<TAnalysisOrderListByCF, TAnalysisOrderListByCFCollection>
	{	   
		public TAnalysisOrderListByCFCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisOrderListByCFCollection</returns>
		public TAnalysisOrderListByCFCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisOrderListByCF o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_OrderListByCF table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisOrderListByCF : ActiveRecord<TAnalysisOrderListByCF>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisOrderListByCF()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisOrderListByCF(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisOrderListByCF(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisOrderListByCF(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_OrderListByCF", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_OrderListByCF",schema);
			}
		}
		#endregion
		...
		{
			TAnalysisOrderListByCF item = new TAnalysisOrderListByCF();
